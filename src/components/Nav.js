...
export default function Navbar() {
  ...
  return (
    ...
    <div className="links flex justify-center width-full height-full ">
        <Link to="/" className= "min-w-fit bg-blue-900 hover:bg-blue-400  font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded" >Home </Link>
        <Link to="/pokedex" className= "min-w-fit bg-blue-900 hover:bg-blue-400 font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded">Pokedex</Link>
        <Link to="/trading-card-game" className= "min-w-fit bg-blue-900 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded">TCG</Link>
    </div>
    </div>   
    </div> 
  )
